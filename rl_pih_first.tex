...
%
% 1) People use vision 
% 2) People use F/T profile human demonstrations
% 3) 
%

% \cite{peg_imcssd_2015} [use vision to estimate pose of pine]
% The authors estimated the pose of the socket through a vision system + blind spiral search
...
%two main approaches to the control problem 
%exists. In first consists of having a 
...
%Programming by Demonstration (PbD) framework. 
%Teleoperated or kinesthetic demonstrations by a human teacher are recorded and a policy is learned and fine-tuned so as to reproduce the same (F)orce/(T)orque profile as 
...
\begin{figure}
 \centering
    \subfigure[]{\includegraphics[width=\textwidth]{./Figures/Fig/traj_experiment5.pdf}}
...
\begin{figure}
 \centering
    \subfigure[]{\includegraphics[width=0.8\textwidth]{./Figures/Fig/experiment5.pdf}}
...
\begin{figure}
 \centering
    \subfigure[]{\includegraphics[width=\textwidth]{./Figures/Results2/socket_connection_A.pdf}}
