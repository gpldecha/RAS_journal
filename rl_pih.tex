...
addressed by trading off online for offline learning methods such as fitted/batch reinforcement learning.
...
input to control output and since more deep learning research has been combined with ADP \cite{mnih-dqn-2015}, \cite{DRQ_AAAI_2015}.
...
architecture and the Q-value function has to have a linear architecture \cite{Sutton00policygradient}. In 
