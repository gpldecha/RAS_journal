...
are used since they do not consider informative prior knowledge. We address this problem by demonstrating how human intuition can be leveraged in an Actor-Critic Fitted Policy Iteration (FPI) framework. 


The critic learns offline in a Fitted RL framework A belief space value function using demonstration from a group of blindfolded human teachers. 
